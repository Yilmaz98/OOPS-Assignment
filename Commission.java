...
public class Commission {
	...
	public static void main(String args[]) {
				...
				for(int i=0;i<n;i++)
				{
					System.out.println("Enter the sales grossed by Employee "+(i+1)+" : ");
				...
				System.out.println("   $1000 and over                             "+mat[8] );
			
			
			
			   System.out.println("Program done by Mohamed Yilmaz Ibrahim(Reg No:2015103064)");
              }
